# MeTeOR
This project is built off of python 3 for the creation of the MeTeOR network and MATLAB for the assessment of the network.
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTExOTIxMTYsLTExMzU2MDQ5M119
-->